...
| 21  | Maps and scenarios            | load editor maps into matches, deterministic triggers, objectives and scripted events, including phase-gated Siege Line completion                                                                         | in progress (all five campaign operations implemented) |
...
| 27  | Commander achievements        | versioned commander profiles and isolated campaign progress; next add trophy registry driven by authoritative exploration, combat, economy and campaign metrics                                            | in progress (commander profiles done)                  |
...
| 30  | Battlefield life and cover    | authored rock formations, tactical blockers, seeded war remains, cosmetic aircraft/flying fauna, plus rare profile-triggered harmless easter eggs such as the runaway chicken                              | planned                                                |
