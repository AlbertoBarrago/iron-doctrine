...
| 27  | HUD build iconography         | production-quality unit/building icons in the build and production queue UI, once the faction sprite pass defines how tanks, vehicles and helicopters read at HUD scale                                   | planned                                                |
