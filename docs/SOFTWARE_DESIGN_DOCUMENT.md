...
| 21  | Maps and scenarios            | load editor maps into matches, deterministic triggers, objectives and scripted events                                 | in progress (First Contact opening implemented)    |
